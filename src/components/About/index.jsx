    ...
    <div id="about" className='container about-container'>
        ...
        <div className='about-content-container'>
          ...
          <div className='about-text'>
            <p className='paragraph-md'>Somos mais que uma agência de marketing: somos um <strong>ecossistema de soluções criativas, tecnológicas e estratégicas</strong> para marcas que querem crescer, se destacar e se conectar de verdade com seu público.</p>
